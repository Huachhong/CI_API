...
abstract class REST_Controller extends CI_Controller
{
    ...
    */
    ...
    public function __construct($config = 'rest')
    {
        ...
        //         Logger::configure(APPPATH.'libraries/log4php/config.xml');
    ...
    public function response($data = NULL, $http_code = NULL, $continue = FALSE)
    {
        ...
        $params = $this->_args ? json_encode($this->_args) : '';
        $ip_address = $this->input->ip_address();
        $requestUri = $this->uri->uri_string();
        //        $this->logger->info("url:${requestUri},method:${method},params:${params},ip_address:${ip_address},result_code:${http_code},result:${output}");
        //log end
